$(document).ready(function() {
    ...
    $('.bh_income').sparkline('html', { type: 'bar', height: '30px', barColor: '#cedd7a', barWidth: 5, });
    $('.bh_traffic').sparkline('html', { type: 'bar', height: '30px', barColor: '#e8769f', barWidth: 5, });
});
$(document).ready(function() {
...
$(document).ready(function() { "use strict"; var options = { valueNames: ['name', 'born'] }; var userList = new List('users', options); });
...
$(window).bind("resize", function() {
    ...
    if ($(this).width() < 1201) { $('.horizontal').removeClass('h_menu') } else { $('.horizontal').addClass('h_menu') }
}).trigger('resize');
