        ...
        showEditor: function() {
            ...
            if (this.$editor === null) {
                ...
                if (options.additionalButtons.length > 0) {
                    $.each(options.additionalButtons[0], function(
                        idx,
                        buttonGroup
                    ) {
                ...
                if (options.fullscreen.enable) {
                    editorHeader
                        .append(
                            '<div class="md-controls"><a class="md-control md-control-fullscreen" href="javascript:void(0);"><span class="' +
                                this.__getIcon(
                ...
                var editorFooter = $("<div/>", { class: "md-footer" }),
                    createFooter = false,
                    footer = "";
                if (options.savable) {
                    createFooter = true;
            ...
            if (options.fullscreen.enable && options.fullscreen !== false) {
                this.$editor.append(
                    '<div class="md-fullscreen-controls">' +
                        '<a href="javascript:void(0);" class="exit-fullscreen" title="Exit fullscreen"><span class="' +
